...
export function LinkedIn({mode, size}: IconProps) {
    return (
        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M8.60938 14V26.5H12.8844V14H8.60938ZM10.7469 11.3313C9.57532 11.3313 8.60938 10.3393 8.60938 9.1656C8.60938 7.99194 9.57532 7 10.7469 7C11.9185 7 12.8844 7.99194 12.8844 9.1656C12.8844 10.3393 11.9185 11.3313 10.7469 11.3313Z" stroke={Colors[mode]} strokeWidth="2"/>
            <path d="M16.2656 14H20.3613V16.4906H20.4188C20.9454 15.4825 22.2486 14.3875 24.2969 14.3875C28.1834 14.3875 29.4 16.8925 29.4 20.7906V26.5H25.1156V21.1556C25.1156 19.5013 25.0745 17.5969 22.6388 17.5969C20.1694 17.5969 19.7906 19.4444 19.7906 21.0388V26.5H16.2656V14Z" stroke={Colors[mode]} strokeWidth="2"/>
        </svg>
    );
}
...
export function ChevronDown({mode, size = '16'}: IconProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M6 9L12 15L18 9" stroke={Colors[mode]} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
    );
}
