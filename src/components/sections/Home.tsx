                ...
                <div className="flex flex-col gap-8 2xl:gap-12 md:order-first">
                    <div className="flex flex-col gap-2">
                        ...
                        <p className="text-body-2-all text-grey-light-600 dark:text-grey-dark-600">
                            I'm a full-stack web developer with 5+ years of experience in building diverse web applications, from e-learning platforms to audit and GRC systems. I specialize in both frontend and backend technologies, working with JavaScript, Typescript, PHP, Python, Laravel, Angular, React, Next.js, React Native, Node.js, and Django, among others. I am skilled in databases like MySQL, PostgreSQL, and MongoDB, and tools like Git, Docker, and AWS. I’m passionate about delivering fast, responsive, and visually appealing digital solutions.
                        </p>
                    </div>
